# application/analyze_occupacao_arima.py
...
def prever_ocupacao_arima(clinica_id: int, dias_previstos: int = 365):
    """
    Previsão de ocupação de leitos usando ARIMA para uma clínica específica com ajuste automático de parâmetros.
    Utiliza dados históricos dos anos de 2022 a 2024 como referência para prever o ano de 2025.
    """
    ...
    previsao_df = pd.DataFrame({"data": pd.date_range(start=date(2025, 1, 1), periods=dias_previstos, freq='D'),
